...
export default function Annotator() {
  ...
  const handleSave = async () => {
    ...
    try {
      await fetch(
        `https://script.google.com/macros/s/AKfycbxfusY4oH_z6aq8HsSfgw5C3tPOVwFz6zJEp_x44_RXkyzv5Q1cL4RvfYPPAd5zSY0/exec?row=${encodeURIComponent(rowId)}&table=${encodeURIComponent(tableName)}&job=${encodeURIComponent(jobId)}`,
        {
          method: "POST",
